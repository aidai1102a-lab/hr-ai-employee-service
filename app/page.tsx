...
export default function Home() {
  ...
  const [mascotUrl, setMascotUrl] = useState("/yabao.png");
  ...
  return (
    <main className="portal">
      <aside className="sidebar">
        <div className="brand">
          <img className="brand-image" src={logoUrl || "/brand-logo.png"} alt={`${companyName} logo`} />
        </div>
        ...
        <header className="hero">
          ...
          <section className="mascot-card">
            <div className="mascot-stage">
              <img className="mascot-image" src={mascotUrl || "/yabao.png"} alt="芽宝" />
            </div>
            <div>
              <strong>芽宝在线</strong>
